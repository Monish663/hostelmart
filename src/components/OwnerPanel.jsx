...
export default function OwnerPanel({ products, orders, saveProds, updateOrderStatus, deleteOrder, onLogout, storeSettings, saveStoreSettings }) {
  ...
  return (
    <div style={{ background:'#FFF8F0', minHeight:'100vh',
      ...
      <div style={{ padding:'24px', maxWidth:'960px', margin:'0 auto' }}>
        {tab === 'dash'    && <OwnerDash    products={products} orders={orders} storeSettings={storeSettings} saveStoreSettings={saveStoreSettings} />}
